...
extern void TIMER0A_Handler( void );                    // A prototype of the interrupt handling function is declared.
...
const intvec_elem __vector_table[] =
{
  ...
  PendSV_Handler,
  SysTick_Handler,
  /* ----------------------- LM4F120H5QR Specific Interrupts (BEGIN) ------------------------ */
  0,
  0,
  0,
  0,
  ...
  0,
  0,
  TIMER0A_Handler                                       // The TIMER0A_Handler is added to the Interrupt Vector Table
/* ----------------------- LM4F120H5QR Specific Interrupts (END) ------------------------ */
};
...
/* ----------------------- LM4F120H5QR Specific Interrupts (BEGIN) ------------------------ */
#pragma call_graph_root = "interrupt"
__weak void TIMER0A_Handler( void ) { while (1) {} }    // Declaration of TIMER0A.
/* ----------------------- LM4F120H5QR Specific Interrupts (END) ------------------------ */
